import svgPaths from "./svg-lqjtyvcrfg";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="chevron-left">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="chevron-left">
          <path d="M10 12L6 8L10 4" id="Vector" stroke="var(--stroke-0, #1A1A1A)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function PromptTab() {
  return (
    <div className="-translate-y-1/2 absolute bg-[#fdfbf7] content-stretch drop-shadow-[-4px_0px_6px_rgba(0,0,0,0.05)] flex flex-col h-[80px] items-center justify-center right-0 rounded-bl-[16px] rounded-tl-[16px] top-1/2 w-[28px]" data-name="prompt-tab">
      <ChevronLeft />
    </div>
  );
}
