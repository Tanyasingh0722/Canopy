import svgPaths from "./svg-tiskwvuhot";
import imgHomescapesMeterwareBaumwollstoffOlivgrun150CmBreit1 from "./1a925d1afd277a89bdb8400a15647e0701333ed2.png";
import imgContainer from "./6e0429e21c91e5382d9ebbbbbf42dd9fc520a5cd.png";
import imgDownloadPremiumPngOfPngGreenBinderClipStationeryElementByPinnAboutClipBinderClipPaperPngPaperAndPaperClip181952721 from "./e131db3a681dbdc10c53504ca297870c7adb0918.png";
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Victor_Mono:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[#0b5d34] text-[8px] tracking-[1.6px] uppercase whitespace-nowrap">
          <span className="leading-[12px]">{`Week 24 - `}</span>
          <span className="leading-[12px]">Entry No. 165</span>
  ...
  return (
    <div className="h-[35px] relative shrink-0 w-[287.156px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[6px] relative size-full">
        <p className="[word-break:break-word] font-['Special_Elite:Regular',sans-serif] leading-[28.6px] not-italic relative shrink-0 text-[#1a2420] text-[26px] tracking-[-0.39px] whitespace-nowrap">June 14</p>
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[287.156px]" data-name="Container">
      <Paragraph />
      <Heading />
    </div>
  );
...
function ButtonMargin() {
  return (
    <div className="content-stretch flex items-start pt-[4px] relative shrink-0" data-name="Button (margin)">
      <Button />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="relative shrink-0">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[93px] items-start relative size-full">
        <Container3 />
        <ButtonMargin />
      </div>
    </div>
...
function Container2() {
  return (
    <div className="absolute content-stretch flex items-start justify-between left-0 mix-blend-multiply opacity-95 pb-[16px] pt-[24px] px-[24px] top-0 w-[460px]" data-name="Container">
      <Frame1 />
    </div>
  );
}
...
function EmotionIcon1() {
  return (
    <div className="relative shrink-0 size-[15px]" data-name="EmotionIcon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g clipPath="url(#clip0_122_2070)" id="EmotionIcon">
...
function Container9() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div aria-hidden className="absolute border-[rgba(11,93,52,0.15)] border-b border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[6px] items-start pb-[17px] pt-[16px] relative size-full">
        <Container10 />
        <Checklist />
      </div>
    </div>
...
function Container4() {
  return (
    <div className="absolute content-stretch flex flex-col h-[512px] items-start left-0 mix-blend-multiply opacity-95 overflow-clip px-[24px] top-[87.41px] w-[460px]" data-name="Container">
      <Container5 />
      <Container7 />
      <Container9 />
      <Container11 />
...
function Container14() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-px pb-[28px] pt-[16px] px-[24px] top-[599.41px]" data-name="Container">
      <Button5 />
    </div>
  );
}
...
function VariantLedger() {
  return (
    <div className="bg-[rgba(255,255,255,0.5)] h-[690px] mix-blend-multiply relative shrink-0 w-full" data-name="VariantLedger">
...
function Container() {
  return (
    <div className="absolute h-[723px] left-[93px] overflow-clip shadow-[0px_32px_80px_0px_rgba(26,22,14,0.35)] top-[148px] w-[460px]" data-name="Container">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute bg-gradient-to-b from-[rgba(255,255,255,0)] inset-0 to-[8.455%] to-white" />
        <div className="absolute inset-0 opacity-20 overflow-hidden">
          <img alt="" className="absolute h-[1935554255737452000%] left-[-218309565109184700%] max-w-none top-[-1557516315163731000%] w-[2686887300130501000%]" src={imgContainer} />
        </div>
      </div>
...
export default function Frame() {
  return (
    <div className="relative size-full">
      <div className="absolute flex h-[725.974px] items-center justify-center left-[4px] top-[181px] w-[660.759px]">
        <div className="flex-none rotate-[-11.23deg]">
          <div className="h-[631.286px] relative w-[548.329px]" data-name="Homescapes Meterware Baumwollstoff olivgrün, 150 cm breit 1">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <img alt="" className="absolute h-[100.08%] left-[-3.04%] max-w-none top-0 w-[115.22%]" src={imgHomescapesMeterwareBaumwollstoffOlivgrun150CmBreit1} />
            </div>
          </div>
        </div>
      </div>
      <Container />
      <div className="absolute flex h-[225.726px] items-center justify-center left-[437.83px] top-0 w-[208.245px]">
        <div className="flex-none rotate-[25.98deg]">
          <div className="h-[181.256px] relative w-[143.33px]" data-name="Download premium png of PNG Green binder clip stationery element_ by Pinn about clip, binder clip, paper png, paper, and paper clip 18195272 1">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <img alt="" className="absolute h-[114%] left-[-22.08%] max-w-none top-[-7%] w-[144.16%]" src={imgDownloadPremiumPngOfPngGreenBinderClipStationeryElementByPinnAboutClipBinderClipPaperPngPaperAndPaperClip181952721} />
            </div>
          </div>
        </div>
      </div>
