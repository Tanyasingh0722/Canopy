import svgPaths from "./svg-xmj5seel9m";

function Container1() {
  return <div className="absolute blur-[38px] left-[250px] rounded-[140px] size-[280px] top-[-70px]" style={{ backgroundImage: "url(\"data:image/svg+xml;utf8,<svg viewBox='0 0 280 280' xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='none'><rect x='0' y='0' height='100%' width='100%' fill='url(%23grad)' opacity='1'/><defs><radialGradient id='grad' gradientUnits='userSpaceOnUse' cx='0' cy='0' r='10' gradientTransform='matrix(0 -19.799 -19.799 0 140 140)'><stop stop-color='rgba(91,143,212,0.19)' offset='0'/><stop stop-color='rgba(46,72,106,0.095)' offset='0.34'/><stop stop-color='rgba(0,0,0,0)' offset='0.68'/></radialGradient></defs></svg>\")" }} data-name="Container" />;
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Victor_Mono:Regular',sans-serif] font-normal leading-[12px] relative shrink-0 text-[#4a7a6a] text-[8px] tracking-[1.6px] uppercase whitespace-nowrap">pause — breathe — record</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d="M12 4L4 12" id="Vector" stroke="var(--stroke-0, #4A7A6A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M4 4L12 12" id="Vector_2" stroke="var(--stroke-0, #4A7A6A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button() {
  return (
    <div className="bg-[rgba(60,50,40,0.07)] content-stretch flex items-center justify-center p-px relative rounded-[16777200px] shrink-0 size-[32px]" data-name="Button">
      <div aria-hidden className="absolute border border-[rgba(0,102,85,0.1)] border-solid inset-0 pointer-events-none rounded-[16777200px]" />
      <Icon />
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="h-[16px] relative shrink-0 w-[79.039px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['Victor_Mono:Regular',sans-serif] font-normal leading-[12px] left-0 text-[#4a7a6a] text-[8px] top-[0.5px] tracking-[1.28px] uppercase whitespace-nowrap">i want to buy</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p12a85900} id="Vector" stroke="var(--stroke-0, #4A7A6A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
          <path d={svgPaths.p380a7500} id="Vector_2" stroke="var(--stroke-0, #4A7A6A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
        </g>
      </svg>
    </div>
  );
...
function Text() {
  return (
    <div className="h-[10.5px] relative shrink-0 w-[55.445px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Victor_Mono:Medium',sans-serif] font-medium leading-[10.5px] left-[28.5px] text-[#4a7a6a] text-[7px] text-center top-[-0.5px] tracking-[0.42px] whitespace-nowrap">Upload image</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute bg-[rgba(60,50,40,0.06)] left-[330.55px] rounded-[14px] top-0" data-name="Button">
      <div aria-hidden className="absolute border border-[rgba(0,102,85,0.1)] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[4px] items-center px-[13px] py-[7px] relative size-full">
        <Icon1 />
        <Text />
      </div>
    </div>
...
function TextInput() {
  return (
    <div className="absolute content-stretch flex flex-col h-[26px] items-start justify-center left-0 overflow-clip top-px w-[412px]" data-name="Text Input">
...
function Container5() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div aria-hidden className="absolute border-[rgba(0,102,85,0.1)] border-b border-solid inset-0 pointer-events-none" />
...
function Paragraph2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Victor_Mono:Regular',sans-serif] font-normal leading-[12px] relative shrink-0 text-[#4a7a6a] text-[8px] tracking-[1.28px] uppercase whitespace-nowrap">it costs</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="absolute h-[30px] left-0 top-0 w-[10.539px]" data-name="Text">
      <p className="[word-break:break-word] absolute font-['Special_Elite:Regular',sans-serif] leading-[30px] left-0 not-italic text-[#4a7a6a] text-[20px] top-0 whitespace-nowrap">$</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[12px] relative shrink-0 w-[97.281px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['Victor_Mono:Regular',sans-serif] font-normal leading-[12px] left-0 text-[#4a7a6a] text-[8px] top-[0.5px] tracking-[1.28px] uppercase whitespace-nowrap">{`what's stirring?`}</p>
      </div>
    </div>
  );
}
...
function EmotionIcon1() {
  return (
    <div className="relative shrink-0 size-[15px]" data-name="EmotionIcon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g clipPath="url(#clip0_115_1051)" id="EmotionIcon">
...
function Paragraph5() {
  return (
    <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Victor_Mono:Regular',sans-serif] font-normal leading-[12px] relative shrink-0 text-[#4a7a6a] text-[8px] tracking-[1.28px] uppercase whitespace-nowrap">buying for</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[18px]" data-name="ForIcon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="ForIcon">
          <path d={svgPaths.pe034900} id="Vector" stroke="var(--stroke-0, #F6F3E4)" strokeWidth="1.2" />
          <path d={svgPaths.p2b850098} id="Vector_2" stroke="var(--stroke-0, #F6F3E4)" strokeLinecap="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function ForIcon1() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="ForIcon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="ForIcon">
          <path d={svgPaths.p22de8600} id="Vector" stroke="var(--stroke-0, #4A7A6A)" strokeWidth="1.125" />
          <path d={svgPaths.p1dd1200} id="Vector_2" opacity="0.6" stroke="var(--stroke-0, #4A7A6A)" strokeWidth="1.125" />
          <path d={svgPaths.pd727890} id="Vector_3" stroke="var(--stroke-0, #4A7A6A)" strokeLinecap="round" strokeWidth="1.125" />
          <path d={svgPaths.p76bb780} id="Vector_4" opacity="0.6" stroke="var(--stroke-0, #4A7A6A)" strokeLinecap="round" strokeWidth="1.125" />
        </g>
      </svg>
    </div>
  );
...
function ForIcon2() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="ForIcon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="ForIcon">
          <path d={svgPaths.p3077bf80} id="Vector" stroke="var(--stroke-0, #4A7A6A)" strokeWidth="1.2" />
          <path d="M9 5.25V9L11.625 11.625" id="Vector_2" stroke="var(--stroke-0, #4A7A6A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          <path d="M12 3H15V6" id="Vector_3" stroke="var(--stroke-0, #4A7A6A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.05" />
          <path d="M11.25 3.75L15 3" id="Vector_4" stroke="var(--stroke-0, #4A7A6A)" strokeLinecap="round" strokeWidth="1.05" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="h-[22px] relative shrink-0 w-[412px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[10px] relative size-full">
        <p className="[word-break:break-word] font-['Victor_Mono:Regular',sans-serif] font-normal leading-[12px] relative shrink-0 text-[#4a7a6a] text-[8px] tracking-[1.28px] uppercase whitespace-nowrap">{`what's on your mind?`}</p>
      </div>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="absolute content-stretch flex flex-col h-[535.406px] items-start left-0 overflow-clip pt-[8px] px-[24px] top-[82.59px] w-[460px]" data-name="Container">
      <Container5 />
      <Container7 />
      <Container9 />
      <Container12 />
...
function Text11() {
  return (
    <div className="h-[15px] relative shrink-0 w-[45.602px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Victor_Mono:Medium',sans-serif] font-medium leading-[15px] left-[23px] text-[#f6f3e4] text-[10px] text-center top-[-0.5px] tracking-[1.6px] uppercase whitespace-nowrap">log it</p>
      </div>
    </div>
  );
}
...
function Container16() {
  return <div className="bg-[#5b8fd4] relative rounded-[5px] shadow-[0px_0px_10px_0px_#5b8fd4] shrink-0 size-[10px]" data-name="Container" />;
}

function Button11() {
  return (
    <div className="bg-[#1a2420] drop-shadow-[0px_8px_14px_rgba(91,143,212,0.19)] opacity-35 relative rounded-[16px] shrink-0 w-[412px]" data-name="Button">
...
function Container15() {
  return (
    <div className="absolute content-stretch flex flex-col items-start justify-center left-0 p-[24px] top-[598px]" data-name="Container">
      <Button11 />
    </div>
  );
}
...
function VariantLedger() {
  return (
    <div className="bg-[#f6f3e4] h-[700px] relative shrink-0 w-full" data-name="VariantLedger">
...
function LogUrgeModalVariations() {
  return (
    <div className="h-[700px] relative shrink-0 w-full" data-name="LogUrgeModalVariations">
...
function Container17() {
  return <div className="bg-[rgba(0,102,85,0.2)] h-[3px] relative rounded-[99px] shrink-0 w-[36px]" data-name="Container" />;
}

function LogUrgeModalVariations1() {
  return (
    <div className="absolute left-0 top-0 w-[460px]" data-name="LogUrgeModalVariations">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start justify-center pb-[4px] pt-[12px] relative size-full">
        <Container17 />
      </div>
    </div>
  );
...
export default function Container() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col items-start overflow-clip relative rounded-[32px] shadow-[0px_32px_80px_0px_rgba(26,22,14,0.35)] size-full" data-name="Container">
      <LogUrgeModalVariations />
      <LogUrgeModalVariations1 />
    </div>
  );
}